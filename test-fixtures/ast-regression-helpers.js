// Shared helpers for the single-file-component (Vue / Svelte) astgen
// regression tests: run astgen over a fixture project, load the emitted
// JSON/typemap pairs, and assert inferred types at source positions.
...
function createOutputRoot(prefix = "atom-parsetools-fixture-") {
...
function loadFixtureSet(fixtureRoot, outputRoot, relativeNames, minTypemapEntries) {
  return Object.fromEntries(
    relativeNames.map((relativeName) => {
      ...
      return [relativeName, { code, ast: ast.ast, typemap, relativeName }];
    })
  );
}
